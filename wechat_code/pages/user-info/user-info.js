...
this.setData({
        ...
        this.setData({
                money: userInfo.money==null?"":userInfo.money,
        })
        this.setData({
                shangjiazhanghao: userInfo.shangjiazhanghao==null?"":userInfo.shangjiazhanghao,
        })
        this.setData({
                mima: userInfo.mima==null?"":userInfo.mima,
        })
        this.setData({
                shangjiamingcheng: userInfo.shangjiamingcheng==null?"":userInfo.shangjiamingcheng,
        })
    userInfo['touxiang']=userInfo?.touxiang?.replace('upload','file')
   this.setData({
           touxiang:baseURL+userInfo.touxiang,
...
this.setData({
        ...
        this.setData({
                shangjiadizhi: userInfo.shangjiadizhi==null?"":userInfo.shangjiadizhi,
        })
...
shangjiadizhi:this.data.shangjiadizhi,
